...
export default function TasksPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      />
      {filteredProjectsPerTasks && filteredProjectsPerTasks?.length > 0 ? (
        <>
        ...
        <div className="rounded-md bg-[#f7f9ff] dark:bg-[#333333] flex justify-center items-center h-60">
          <h2 className="text-center">{t("noTasksFound")}</h2>
        </div>
      )}
    </div>
  );
